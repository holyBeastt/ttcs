...
const mapDetailResponse = (mainRow, participantRows) => ({
  ...
  maSo: mainRow.ma_so,
  soQuyetDinh: mainRow.so_quyet_dinh,
  capNhiemVu: mainRow.cap_nhiem_vu,
  kinhPhi: mainRow.kinh_phi,
  tenTapChi: mainRow.ten_tap_chi,
  soBao: mainRow.so_bao,
  soTrichDan: mainRow.so_trich_dan,
  coQuanChuTri: mainRow.co_quan_chu_tri,
  coQuanChuQuan: mainRow.co_quan_chu_quan,
  thuocNhiemVu: mainRow.thuoc_nhiem_vu,
  linhVucNghienCuu: mainRow.linh_vuc_nghien_cuu,
  kinhPhiNamNhat: mainRow.kinh_phi_nam_nhat,
  kinhPhiNamHai: mainRow.kinh_phi_nam_hai,
  kinhPhiNamBa: mainRow.kinh_phi_nam_ba,
  nguonKinhPhi: mainRow.nguon_kinh_phi,
  ngayQuyetDinh: mainRow.ngay_quyet_dinh,
