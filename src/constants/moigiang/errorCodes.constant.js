...
const ERROR_CODES = Object.freeze({
  ...
  VALIDATION: Object.freeze({
    ...
    /** 400 - SoSinhVien không phải số nguyên dương */
    INVALID_SO_SINH_VIEN: 'MG_VAL_011',
    /** 400 - HeSoLopDong không phải số thực >= 0 */
    INVALID_HE_SO_LOP_DONG: 'MG_VAL_012',
    /** 400 - HeSoT7CN không phải số thực >= 0 */
    INVALID_HE_SO_T7CN: 'MG_VAL_013',
  }),
...
const HTTP_STATUS_MAP = Object.freeze({
  ...
  [ERROR_CODES.VALIDATION.INVALID_SO_SINH_VIEN]: 400,
  [ERROR_CODES.VALIDATION.INVALID_HE_SO_LOP_DONG]: 400,
  [ERROR_CODES.VALIDATION.INVALID_HE_SO_T7CN]: 400,
