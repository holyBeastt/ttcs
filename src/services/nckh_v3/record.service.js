...
const detail = async (id) => {
  ...
  try {
    ...
    return {
      ...
      soQuyetDinh: main.so_quyet_dinh || null,
      capNhiemVu: main.cap_nhiem_vu || null,
      kinhPhi: main.kinh_phi || null,
      tenTapChi: main.ten_tap_chi || null,
      soBao: main.so_bao || null,
      soTrichDan: main.so_trich_dan ?? null,
      coQuanChuTri: main.co_quan_chu_tri || null,
      coQuanChuQuan: main.co_quan_chu_quan || null,
      thuocNhiemVu: main.thuoc_nhiem_vu || null,
      linhVucNghienCuu: main.linh_vuc_nghien_cuu || null,
      kinhPhiNamNhat: main.kinh_phi_nam_nhat || null,
      kinhPhiNamHai: main.kinh_phi_nam_hai || null,
      kinhPhiNamBa: main.kinh_phi_nam_ba || null,
      nguonKinhPhi: main.nguon_kinh_phi || null,
      ngayQuyetDinh: main.ngay_quyet_dinh || null,
      participants: participants.map((item) => ({
        ...
        maPhongBan: item.MaPhongBan || null,
        soTiet: round2(Number(item.so_tiet || 0)),
        namThucHien: Number(item.nam_thuc_hien || 1),
      })),
    };
  } finally {
    if (connection) connection.release();
